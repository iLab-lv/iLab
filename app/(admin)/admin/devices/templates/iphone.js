export function createIphoneTemplate({ deviceName, htmlDeviceName }) {
  return {
    lv: {
      ...
      metaDescription: `Profesionāls ${deviceName} remonts Rīgā: ekrāns, baterija, uzlāde un kamera. Kvalitatīvas detaļas, bezmaksas diagnostika un 90 dienu garantija.`,
    ...
    ru: {
      ...
      metaDescription: `Профессиональный ремонт ${deviceName} в Риге: экран, аккумулятор, зарядка и камера. Качественные детали, бесплатная диагностика и гарантия 90 дней.`,
