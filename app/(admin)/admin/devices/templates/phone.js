export function createPhoneTemplate({ deviceName, htmlDeviceName, seoDeviceName }) {
  return {
    lv: {
      ...
      metaDescription: `${seoDeviceName} remonts Rīgā: ekrāns, baterija, uzlāde un kamera. Ātra diagnostika, skaidra cena un garantija līdz 1 gadam.`,
    ...
    ru: {
      ...
      metaDescription: `Ремонт ${seoDeviceName} в Риге: экран, аккумулятор, зарядка и камера. Быстрая диагностика, понятная цена и гарантия до 1 года.`,
