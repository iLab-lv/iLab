import IphoneScreenServicePage from './IphoneScreenServicePage';
...
const strings = {
  ...
  processName: 'iPhone ekrāna maiņa',
  processDescription:
    'Kā iLab servisā notiek iPhone ekrāna maiņa: diagnostika, cenas saskaņošana, displeja nomaiņa, pārbaude un garantija.',
  processSteps: [
    {
      name: 'Diagnostika',
      text: 'Pārbaudām ekrānu, skārienjutību un iPhone darbību.',
    },
    {
      name: 'Cena un termiņš',
      text: 'Pirms darba sākšanas saskaņojam ekrāna maiņas cenu un izpildes laiku.',
    },
    {
      name: 'Ekrāna maiņa',
      text: 'Nomainām displeju un pārbaudām jaunās detaļas pieslēgumu.',
    },
    {
      name: 'Pārbaude',
      text: 'Testējam attēlu, skārienjutību, Face ID un galvenās funkcijas.',
    },
    {
      name: 'Garantija',
...
export default async function Page({ searchParams }) {
  ...
  return (
    <>
      <JsonLd id="iphone-screen-service-jsonld" data={data.jsonLd} />
