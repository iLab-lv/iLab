...
function getHeroImage(page) {
  return page?.source?.category?.image || '/images/categories/plansetdatoru_remonts.webp';
}
...
function buildBrandItemList(brandBlocks = [], basePath) {
  return buildItemListLd(
    brandBlocks.map((brand) => ({
      name: `${brand.name} planšetdatoru remonts`,
      url: brand.href,
    })),
    {
...
export default async function Page() {
  ...
  return (
    <>
      <JsonLd id="plansetdatoru-remonts-jsonld" data={jsonLd} />
