...
const strings = {
  ...
  introP2:
    'После ремонта проверяем звук во время звонка, динамик, микрофон, запись видео и основные функции. На работу и установленные детали предоставляем гарантию до 1 года.',
  ...
  processSteps: [
    ...
    {
      title: 'Гарантия',
      text: 'После ремонта предоставляем гарантию до 1 года на работу и детали.',
    },
  ],
  ...
  serviceDescription:
    'Ремонт динамика и микрофона iPhone в Риге: диагностика, чистка или замена детали, гарантия до 1 года.',
