...
const strings = {
  ...
  heroBodyHtml:
    '<p><strong>Замена батареи iPhone в Риге</strong> в сервисе iLab - быстрая диагностика, качественные детали и <strong>гарантия до 1 года</strong>. Часто замену аккумулятора выполняем в тот же день.</p>',
  ...
  serviceDescription:
    'Замена батареи iPhone в Риге: бесплатная диагностика, гарантия до 1 года.',
  ...
  headerLead:
    'Меняем аккумулятор iPhone, если батарея быстро разряжается, телефон выключается, греется или нестабильно показывает заряд. До ремонта проводим диагностику, согласовываем стоимость и после замены выдаём гарантию до 1 года.',
