import IphoneBackCoverServicePage from '@site/(catalog)/iphone-remonts/(services)/aizmugures-vacina-maina/IphoneBackCoverServicePage';
...
const strings = {
  ...
  heroBodyHtml:
    '<p><strong>Замена задней крышки iPhone в Риге</strong> в сервисе iLab - аккуратная замена корпуса или заднего стекла, точная диагностика и <strong>гарантия до 1 года</strong>. Поможем, если заднее стекло треснуло, отклеилось или повреждено после падения.</p>',

  priceTitle: 'Цены на замену задней крышки по моделям',
  ctaLabel: 'Записаться на ремонт',

  faqTitle: 'Вопросы',

  breadcrumbServiceName: 'Замена задней крышки',
  serviceName: 'Замена задней крышки iPhone в Риге',
  serviceType: 'Замена задней крышки iPhone',
  serviceDescription:
    'Замена задней крышки iPhone в Риге. Бесплатная диагностика и гарантия до 1 года.',

  homeCrumb: 'Главная',
  hubCrumb: 'Ремонт iPhone',
  otherModels: 'Другие модели',

  headerTitle: 'Замена задней крышки iPhone в Риге',
  headerLead:
    'Меняем заднее стекло или крышку корпуса iPhone, если она треснула, отклеилась, поцарапана или повреждена после падения. До ремонта проводим диагностику, согласовываем стоимость и после замены выдаём гарантию до 1 года.',
  headerCtaLabel: 'Смотреть цены',

  applyAria: 'Записаться на ремонт',

  processName: 'Замена задней крышки iPhone',
  processDescription:
    'Как проходит замена задней крышки iPhone в iLab: диагностика, согласование цены, замена детали, проверка и гарантия.',
  processSteps: [
    {
      name: 'Диагностика',
      text: 'Проверяем корпус, стекло камеры, беспроводную зарядку и работу iPhone.',
    },
    {
      name: 'Цена и сроки',
      text: 'Согласовываем стоимость и срок замены задней крышки до начала работ.',
    },
    {
      name: 'Замена крышки',
      text: 'Меняем повреждённое заднее стекло или деталь корпуса и проверяем соединения.',
    },
    {
      name: 'Проверка',
      text: 'Тестируем зону камеры, беспроводную зарядку и основные функции.',
    },
    {
      name: 'Гарантия',
      text: 'Предоставляем гарантию до 1 года на работу и установленную деталь.',
    },
  ],
};
...
export default async function Page({ searchParams }) {
  ...
  return (
    <>
      <JsonLd id="iphone-back-cover-service-ru-jsonld" data={data.jsonLd} />
