...
const strings = {
  ...
  heroBodyHtml:
    '<p><strong>Замена задней крышки iPhone в Риге</strong> в сервисе iLab - аккуратная замена корпуса или заднего стекла, точная диагностика и <strong>гарантия 90 дней</strong>. Поможем, если заднее стекло треснуло, отклеилось или повреждено после падения.</p>',
  ...
  serviceDescription:
    'Замена задней крышки iPhone в Риге. Бесплатная диагностика и гарантия 90 дней.',
  ...
  headerLead:
    'Меняем заднее стекло или крышку корпуса iPhone, если она треснула, отклеилась, поцарапана или повреждена после падения. До ремонта проводим диагностику, согласовываем стоимость и после замены выдаём гарантию 90 дней.',
