...
const strings = {
  ...
  pageDescription:
    'Быстрая и качественная замена экрана телефона в Риге. Бесплатная диагностика, гарантия до 1 года, оригинальные или OEM дисплеи. Часто в тот же день.',
  ...
  headerLead:
    'Меняем экран телефона при трещинах, пятнах, полосах и проблемах с сенсором. До ремонта проводим диагностику и после замены выдаём гарантию до 1 года.',
  headerCtaLabel: 'Смотреть цены',

  heroAlt: seo.imageAlt,
  heroImage: '/images/categories/displeja_maina.webp',
  heroBodyHtml:
    '<p><strong>Быстрая и качественная замена экрана телефона в Риге</strong> - трещины, пятна и проблемы с сенсором устраняем часто в тот же день. Бесплатная диагностика и <strong>гарантия до 1 года</strong> на каждый ремонт в iLab.</p>',
  ...
  introP2:
    'После замены тщательно проверяем чувствительность сенсора, цветопередачу, яркость и общее качество изображения. Популярные модели обычно ремонтируем за <strong>1–3 часа</strong>. На работу и детали действует <strong>гарантия до 1 года</strong>.',
  ...
  processSteps: [
    ...
    {
      title: 'Гарантия',
      text: 'Выдаём устройство с гарантией до 1 года на деталь и работу, а также даём рекомендации по бережному использованию экрана.',
    },
  ],
  ...
  serviceDescription:
    'Замена экрана телефона в Риге: бесплатная диагностика, оригинальные или OEM дисплеи, гарантия до 1 года. Часто в тот же день.',
