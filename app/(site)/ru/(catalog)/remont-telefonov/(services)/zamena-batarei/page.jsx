...
const strings = {
  ...
  pageDescription:
    'Быстрая и качественная замена батареи телефона в Риге. Бесплатная диагностика, гарантия до 1 года, оригинальные или OEM батареи. Часто в тот же день.',
  ...
  headerLead:
    'Меняем батарею телефона, если устройство быстро разряжается, выключается при 10–20%, нагревается или нестабильно держит заряд. До ремонта проводим диагностику и после замены выдаём гарантию до 1 года.',
  headerCtaLabel: 'Смотреть цены',

  heroAlt: seo.imageAlt,
  heroImage: '/images/categories/baterijas_maina.webp',
  heroBodyHtml:
    '<p><strong>Быстрая и безопасная замена батареи телефона в Риге</strong> - если устройство быстро разряжается, выключается при 20% или заряжается слишком медленно, поможем. Бесплатная диагностика и <strong>гарантия до 1 года</strong> на каждый ремонт в iLab.</p>',
  ...
  introP2:
    'После замены выполняем <strong>калибровку батареи</strong> и тесты - стабильность зарядки/разрядки, температуру и программные показатели. Популярные модели обычно ремонтируем за <strong>45–90 минут</strong>. На детали и работу действует <strong>гарантия до 1 года</strong>.',
  ...
  processSteps: [
    ...
    {
      title: 'Гарантия',
      text: 'Выдаём устройство с гарантией до 1 года на деталь и работу, а также даём рекомендации по бережному использованию батареи.',
    },
  ],
  ...
  serviceDescription:
    'Замена батареи телефона в Риге: бесплатная диагностика, оригинальные или OEM батареи, гарантия до 1 года. Часто в тот же день.',
