...
const strings = {
  ...
  pageDescription:
    'Размытые фото, проблемы с фокусировкой или не работает камера? Ремонт и замена камеры телефона в Риге. Бесплатная диагностика и гарантия до 1 года.',
  ...
  headerLead:
    'Ремонтируем камеру телефона при размытых фото, проблемах с фокусировкой, повреждённом стекле камеры или ошибках камеры. До ремонта проводим диагностику и после ремонта выдаём гарантию до 1 года.',
  headerCtaLabel: 'Смотреть цены',

  heroAlt: seo.imageAlt,
  heroImage: '/images/categories/kameras_remonts.webp',
  heroBodyHtml:
    '<p><strong>Ремонт камеры телефона в Риге</strong> - размытое изображение, повреждённое стекло или проблемы с фокусировкой? Выполняем диагностику и при необходимости <strong>замену модуля камеры или стекла</strong>. Бесплатная проверка и <strong>гарантия до 1 года</strong>.</p>',
  ...
  introP2:
    'После ремонта проверяем фокусировку, стабилизацию, качество фото и видео, а также работу приложения камеры. Популярные модели обычно ремонтируем за <strong>1–3 часа</strong>. На все работы и детали действует <strong>гарантия до 1 года</strong>.',
  ...
  processSteps: [
    ...
    {
      title: 'Гарантия',
      text: 'Выдаём устройство с гарантией до 1 года на деталь и работу, а также даём рекомендации по бережному использованию камеры.',
    },
  ],
  ...
  serviceDescription:
    'Ремонт и замена камеры телефона в Риге: размытые фото, проблемы с фокусировкой, повреждённое стекло. Бесплатная диагностика и гарантия до 1 года.',
