...
const strings = {
  ...
  pageDescription:
    'Тихий звук, хрипы или во время разговора не слышно? Ремонт и чистка динамика и микрофона телефона в Риге. Бесплатная диагностика и гарантия до 1 года.',
  ...
  headerLead:
    'Ремонтируем динамик и микрофон телефона, если звук тихий, искажённый, с хрипами или вас не слышно во время разговора. До ремонта проводим диагностику и после ремонта выдаём гарантию до 1 года.',
  headerCtaLabel: 'Смотреть цены',

  heroAlt: seo.imageAlt,
  heroImage: '/images/categories/mikrofona_remonts.webp',
  heroBodyHtml:
    '<p><strong>Ремонт динамика и микрофона в Риге</strong> - если во время разговора не слышно, звук тихий, с хрипами или в записи голоса есть шум, выполним чистку или замену модулей. Бесплатная диагностика и <strong>гарантия до 1 года</strong>.</p>',
  ...
  introP2:
    'После ремонта проверяем разговорный динамик, мультимедийный динамик, все микрофоны и шумоподавление в разных сценариях: разговор, громкая связь и запись голоса. Популярные модели обычно ремонтируем за <strong>45–90 минут</strong>. На работу и детали действует <strong>гарантия до 1 года</strong>.',
  ...
  processSteps: [
    ...
    {
      title: 'Гарантия',
      text: 'Выдаём устройство с гарантией до 1 года на деталь и работу, а также даём рекомендации по защите от пыли и влаги.',
    },
  ],
  ...
  serviceDescription:
    'Ремонт и чистка динамика и микрофона телефона в Риге: тихий звук, хрипы, проблемы во время разговора или шум. Бесплатная диагностика и гарантия до 1 года.',
