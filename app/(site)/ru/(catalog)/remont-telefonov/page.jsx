...
const fallbackDescription =
  'Ремонт телефонов всех брендов: экран, батарея, разъём зарядки, камера, повреждения от влаги. Быстрая диагностика, честные цены, гарантия до 1 года.';

const labels = {
  heroAlt: 'ремонт телефонов в Риге',
  heroBodyHtml:
    '<p><strong>Быстрый и безопасный ремонт телефонов в Риге</strong> - замена экрана, батареи и камеры в тот же день. Бесплатная диагностика и <strong>гарантия до 1 года</strong>.</p>',
