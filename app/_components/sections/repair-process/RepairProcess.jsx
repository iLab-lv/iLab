...
export default function RepairProcess({ id='repair-process', locale='lv', variant='iphone', backgroundImage, content: suppliedContent }) {
  const content=suppliedContent || getRepairProcessContent(locale,variant);
