const content = {
  lv: {
    meta: {
      ...
      description: 'Fotoaparātu un objektīvu remonts Rīgā. Fototehnikas diagnostika, cena pirms darba un garantija līdz 1 gadam iLab servisā.',
      ogDescription: 'Fotoaparātu, objektīvu un citas fototehnikas diagnostika un remonts iLab servisā Rīgā. Cena pirms darba un garantija līdz 1 gadam.',
    ...
    facts: [
      ['warranty', 'Garantija līdz 1 gadam', 'Darbam un uzstādītajām detaļām.'],
    ...
    quality: { eyebrow: 'Kvalitāte un garantija', title: 'Fotoaparātu remonts ar pārbaudi pēc darba', intro: 'Pēc darba pārbaudām funkcijas, kas saistītas ar veikto remontu, un pārliecināmies, ka ierīce darbojas stabili.', items: [
      ...
      { title: 'Garantija līdz 1 gadam', text: 'Veiktajam remontam un uzstādītajām detaļām nodrošinām garantiju līdz 1 gadam atbilstoši remonta veidam.' },
    ...
    process: { eyebrow: 'Process servisā', title: 'Kā notiek fotoaparātu remonts', intro: 'Vienkāršs process no sākotnējās pārbaudes līdz saskaņotam remontam un ierīces pārbaudei.', items: [
      ...
      { title: 'Saņem ierīci ar garantiju', text: 'Pēc remonta saņem pārbaudītu ierīci ar garantiju līdz 1 gadam veiktajam darbam un uzstādītajām detaļām.' },
    ] },
...
content.ru = {
  ...
  facts: [['warranty','Гарантия до 1 года','На выполненные работы и установленные детали.'],['diagnostics','Диагностика до ремонта','Сначала определяем причину неисправности.'],['price','Цена до начала работ','Стоимость согласовываем до начала ремонта.'],['locations','Два сервиса в Риге','Выберите удобный сервис iLab.']],
  ...
  quality:{eyebrow:'Качество и гарантия',title:'Ремонт фотоаппаратов с проверкой после работы',intro:'После ремонта проверяем связанные функции и убеждаемся, что устройство работает стабильно.',items:[{title:'Проверка после ремонта',text:'Проверяем питание, управление, фокусировку, дисплей, соединения и контакты.'},{title:'Гарантия до 1 года',text:'Предоставляем гарантию до 1 года на выполненный ремонт и установленные детали в зависимости от вида ремонта.'},{title:'Цена согласована заранее',text:'Начинаем ремонт после согласования решения, стоимости и срока.'},{title:'Ремонт после диагностики',text:'Объём работ определяем после проверки устройства, а не только по описанному симптому.'}]},
