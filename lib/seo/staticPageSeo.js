...
export const staticPageSeo = {
  home: {
    ...
    title: {
      lv: 'Telefonu remonts Rīgā - iPhone, Samsung, datoru un citu ierīču remonts',
      ru: 'Ремонт телефонов в Риге - ремонт iPhone, Samsung, компьютеров и других устройств',
    },
  ...
  iphoneWaterDamageRepair: {
    ...
    title: {
      lv: 'iPhone ūdens bojājumu diagnostika Rīgā | iLab',
      ru: 'Диагностика iPhone после воды в Риге | iLab',
    },

    description: {
      lv: 'iPhone ūdens bojājumu diagnostika Rīgā. Ko darīt, ja iPhone samirka, nelādējas vai neieslēdzas. Diagnostika no 50 €, remonts pēc pārbaudes.',
      ru: 'Диагностика iPhone после воды в Риге. Что делать, если iPhone намок, не заряжается или не включается. Диагностика от 50 €, ремонт после проверки.',
    },
  ...
  iphoneBackCoverReplacement: {
    ...
    description: {
      lv: 'iPhone aizmugures vāciņa un stikla maiņa Rīgā. Bezmaksas diagnostika, skaidra cena, kvalitatīvas detaļas un garantija līdz 1 gadam.',
      ru: 'Замена задней крышки и стекла iPhone в Риге. Бесплатная диагностика, понятная цена, качественные детали и гарантия до 1 года.',
    },
  ...
  iphoneBoardRepair: {
    ...
    route: {
      lv: '/iphone-remonts/iphone-plates-remonts',
      ru: '/ru/remont-iphone/remont-platy-iphone',
    },

    title: {
      lv: 'Mikrolodēšana un iPhone plates remonts Rīgā | iLab',
      ru: 'Микропайка и ремонт платы iPhone в Риге | iLab',
    },

    description: {
      lv: 'iPhone mātesplates diagnostika, mikrolodēšana un plates remonts Rīgā. Palīdzam pēc mitruma, trieciena, uzlādes un barošanas bojājumiem.',
      ru: 'Диагностика материнской платы iPhone, микропайка и ремонт платы в Риге. Помогаем после влаги, удара, проблем с зарядкой и питанием.',
    },

    imageAlt: {
      lv: 'iPhone plates remonts un mikrolodēšana iLab servisā Rīgā',
      ru: 'Ремонт платы iPhone и микропайка в сервисе iLab в Риге',
    },
